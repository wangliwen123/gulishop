...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("E:/idea-workspace/gmall-parent\\gmall-mbg" + "/src/main/java");
        gc.setAuthor("WangLW");
        ...
        gc.setBaseResultMap(true);  //生成基本mapper
        ...
        dsc.setUrl("jdbc:mysql://192.168.81.128:4306/gmall_"+moduleName+"?useUnicode=true&useSSL=false&characterEncoding=utf8");
